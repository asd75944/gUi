...
The following is a set of guidelines for contributing to gui. Please spend several minutes in reading these guidelines before you create an issue or pull request.
...
```bash
git clone git@github.com:asd75944/gui.git
